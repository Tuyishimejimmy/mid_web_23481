...
<body class="bg-gray-100">
                ...
                <form id="membershipForm" class="text-left">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="w-full px-3 py-2 border rounded-lg" 
                               value="${membershipDetails.maxBooks}" 
                               max="${membershipDetails.maxBooks}" 
                               readonly>
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Price per Day (Rwf)</label>
                        <input type="number" class="w-full px-3 py-2 border rounded-lg" 
                               value="${membershipDetails.price}" readonly>
                    </div>
    ...
    function submitMembershipApplication(membershipDetails) {
        fetch('${pageContext.request.contextPath}/membership', {
            ...
            body: `membershipName=${membershipDetails.name}&maxBooks=${membershipDetails.maxBooks}&price=${membershipDetails.price}`
        })
